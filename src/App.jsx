...
import RBSelect from './r-select/r-select';
import './App.css';
     ...
     return (
       <div className="container">
         ...
         <div className="content-area">
           <p>A basic custom select that behaves in a similar fashion to the
           HTML select control.
           </p>
           <p className="selected-option-display">
           ...
           <Highlight
             className="code-snippit"
             lang="javascript"
             value={"{ selectedOption: 'String', target: {name:'String'}}"}
           />
           <p>The select responds to keyboard navigation.
           Press return to open and select a result, esc to close
            and up or down to navigate the list. Whilst the list is open it is possible to perform
            primitive character matching, e.g. pressing &apos;c&apos;
            will highlight the first result that begins with c.
           </p>
         </div>
         <div className="footer-area">
           <span className="footer-text">By
             <a
               href="http://rrayns.co.uk"
               target="_blank"
